...
import { X, Quote, Link, Trash2 } from 'lucide-react';
...
interface InspirationModalProps {
  ...
  newInspiration: { title: string; content: string; url: string };
  setNewInspiration: (data: any) => void;
  setSelectedInspiration: (data: any) => void;
